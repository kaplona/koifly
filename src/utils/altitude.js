...
const Altitude = {
   ...
   */
  getAltitudeInPilotUnits(altitude) {
   ...
   */
  getAltitudeInGivenUnits(altitude, units) {
   ...
   */
  getAltitudeInMeters(nextValue, previousValue, units) {
   ...
   */
  convertAltitudeToMeters(altitude, units) {
   ...
   */
  getVelocityInGivenUnits(value, units) {
